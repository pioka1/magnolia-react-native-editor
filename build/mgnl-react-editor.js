...
var EditableArea = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(EditableArea, [{
    ...
    value: function render() {
      ...
      var AreaWrapper = wrapperComponent || react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('div').type;
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(AreaWrapper, {
        ref: function ref(node) {
          return _this2.node = node;
        },
        key: content['@id'],
        className: _util__WEBPACK_IMPORTED_MODULE_4__["ComponentHelper"].classnames(className)
      }, children, componentNames.map(function (name) {
...
_defineProperty(EditableArea, "propTypes", {
  ...
  wrapperComponent: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.node,
...
var EditableComponent = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(EditableComponent, [{
    ...
    value: function render() {
      ...
      var ComponentWrapper = wrapperComponent || react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('div').type;
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ComponentWrapper, {
        ref: function ref(node) {
          return _this2.openNode = node;
        }
      }), component, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ComponentWrapper, {
        ref: function ref(node) {
...
_defineProperty(EditableComponent, "propTypes", {
  ...
  wrapperComponent: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.node
});
...
var EditablePage = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(EditablePage, [{
    ...
    value: function render() {
      ...
      var PageWrapper = wrapperComponent || react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('div').type;
      var contextValue = this.getContextValue();
      var pageComponent = this.hasPageComponent() ? _util__WEBPACK_IMPORTED_MODULE_3__["ComponentHelper"].getRenderedComponent(contextValue.content, contextValue.componentMappings) : children; // NOTE: We need a div tag as a parent node for Page's child HTML. It will cause an issue if we
